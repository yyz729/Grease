...
public class ModItems {
    ...
    public static void register(){
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "lightning_grease"), LIGHTNING_GREASE);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "sacred_grease"), SACRED_GREASE);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "fire_grease"), FIRE_GREASE);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "magic_grease"), MAGIC_GREASE);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "poison_grease"), POISON_GREASE);
        Registry.register(Registries.ITEM, Identifier.of(MOD_ID, "freezing_grease"), FREEZING_GREASE);

        Registry.register(Registries.ITEM_GROUP, Identifier.of(MOD_ID, "group"), GREASE);
    }
}
